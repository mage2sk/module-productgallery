<?php
/**
 * Daily heartbeat cron for Panth_ProductGallery. Skips if Panth_Core is
...
namespace Panth\ProductGallery\Cron;

use Magento\Framework\Module\Manager as ModuleManager;
use Panth\ProductGallery\Service\InstallReporter;
