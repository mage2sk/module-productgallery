<?php
/**
 * Standalone install + heartbeat reporter for Panth_ProductGallery.
 *
...
namespace Panth\ProductGallery\Service;
...
{
    public const MAGENTO_MODULE = 'Panth_ProductGallery';
    public const COMPOSER_PACKAGE = 'mage2kishan/module-productgallery';
